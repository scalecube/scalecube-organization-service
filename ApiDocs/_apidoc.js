...
/**
  ...
  * @apiPermission Request / Response / Error-response
  *
  * @apiDescription This operation enables only organization managers <b>(Owner/Admin)</b> to create the API key (token) and store it
  * in the relevant organization. Each API key got the unique name which couldn't be duplicated.
  * >Note: API keys assigned with any of the relevant roles (Owner/Admin/Member) don't corresponds with the organization members similar roles
  * and purposed only for the appropriate permission level (write or read) provision for <a href="http://scalecube.io/configuration-service/index.html">Configuration service</a> users
  *
  * @apiParam {Object} token The requested token issued by relevant authority (Auth0)
  ...
  * <br>All relevant API keys issued for organization also deleted thus become invalid upon this operation was done
  *
  * @apiParam {Object} token The requested token issued by relevant authority (Auth0)
  * @apiParam {String} organizationId Already stored id for the specific organization
  *
 ...
 * @apiPermission Request / Response / Error-response
 *
 * @apiDescription This operation enables only organization managers <b>(Owner/Admin)</b> to delete the API key (token) from the relevant organization.
 * >Note: API keys assigned with any of the relevant roles (Owner/Admin/Member) don't corresponds with the organization members similar roles
 * and purposed only for the appropriate permission level (write or read) provision for <a href="http://scalecube.io/configuration-service/index.html">Configuration service</a> users
 *
 * @apiParam {Object} token The requested token issued by relevant authority (Auth0)
 ...
 * @apiSuccess {String} ownerId id for clients already generated by relevant authority (Auth0)
 *
 * @apiError {String} field Invalid role (permission level) for specified organization member either organization outsider
 *
 * @apiErrorExample {json} WebSocket
 * Request:
 *     {
 ...
 *//**
  ...
  * @apiPermission Request / Response / Error-response
  *
  * @apiDescription This operation enables <b>all members</b> of the relevant organization to get the organization information
  *
  * @apiParam {Object} token The requested token issued by relevant authority (Auth0)
  * @apiParam {String} organizationId Already stored id for the specific organization
  *
...
/**
  ...
  * (which client id issued by relevant authority - <a href="https://manage.auth0.com/">Auth0</a>) to step into relevant organization
  *
  * @apiParam {Object} token The requested token issued by relevant authority (Auth0)
  * @apiParam {String} organizationId Already stored id for the specific organization
  * @apiParam {String} userId Already stored id for the specific organization issued by relevant authority (Auth0)
 ...
 *
 * @apiError {String} field value of invalid or non-existent organization id
 *
 * @apiErrorExample {json} WebSocket
 * Request:
 *     {
...
/**
  ...
  * @apiPermission Request / Response / Error-response
  *
  * @apiDescription This operation enables only organization managers <b>(Owner/Admin)</b> to create the API key (token) for the relevant organization and further
  * to be used by potential users of the <a href="http://scalecube.io/configuration-service/index.html">Configuration service</a> according to appropriate permission level.
...
/**
  ...
  * Organization managers could provide and delete the relevant API keys (permission level with appropriate assigned role: Owner/Admin/Member) which are vital leverage
  * for the <a href="http://scalecube.io/configuration-service/index.html">Configuration service</a> management and security purpose.
  * >Note: API keys assigned with some of the relevant role (Owner/Admin/Member) doesn't correspond with the organization members' similar roles and purposed
  * only for the appropriate permission level (write or read) provision for <a href="http://scalecube.io/configuration-service/index.html">Configuration service</a> users
  *
  * <b>Getting Started</b>
  *
  *
