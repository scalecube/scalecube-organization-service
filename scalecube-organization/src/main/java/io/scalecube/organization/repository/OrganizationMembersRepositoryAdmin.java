...
public interface OrganizationMembersRepositoryAdmin {
     ...
     * @param organization The organization to which a members repository should be created.
     */
     ...
     * @param organization The organization to which the members repository should be deleted.
     */
